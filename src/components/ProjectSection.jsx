          ...
          <p className="text-gray-600 w-full">
            ...
            <ul>
              ...
              <li>
                ...
                Health (SRH) cones in disaster management.
              </li>
              <li>
          ...
          <p className="text-gray-600">
            ...
            <ul>
              ...
              <li>
                ...
                WWF Nepal Program Team and get Approval from Hariyo Ban Program
                Team
              </li>
              <li>
                • Management of Meetings and Training Program; Obtain Permission
              ...
              <li>
                • Final DPRP of Vyas Municipality, Myagde Rural Municipality and
        ...
        <div className="p-4">
          ...
          <p className="text-gray-600">
            ...
            <ul>
              ...
              <li>
                • Major map preparation of landslide hazard risk area of Gandaki
                Province and
              </li>
              <li>
                • Preparation of profile and brief indicative plan of landslides
                and their treatment measures in Gandaki Province.
              </li>
            </ul>
          </p>
        </div>
          ...
          <p className="text-gray-600">
            ...
            <ul>
              ...
              <li>
                ...
                Interpretation, Formulation of Mitigation measures
              </li>
