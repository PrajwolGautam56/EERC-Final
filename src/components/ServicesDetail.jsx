          ...
          {services.services.map((service) => {
            return (
              ...
              <div
                ...
                className="bg-transparent rounded backdrop-blur-sm shadow-lg hover:shadow-xl overflow-hidden flex flex-col md:flex-row transform transition-transform hover:scale-105"
              >
                <div className="p-4">
